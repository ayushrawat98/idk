...
route.get('/cleanup', async (req, res, next) => {
	const allThreadsToDelete = instance.db.prepare('select id from posts where parent_id is null and board_id = 1 order by updated_at desc limit -1 offset 20').all()
